...
if __name__ == ("__main__"):
    ...
    img_lq = cv2.resize(img_lq, (int(w // scale), int(h // scale)), interpolation=cv2.INTER_LINEAR)/255
    img_lq = random_add_gaussian_noise(img_lq, [0, 20])
    img_lq = random_add_jpg_compression(img_lq, [60, 100])*255
    img_lq = cv2.resize(img_lq, (w, h), interpolation=cv2.INTER_LINEAR)
    cv2.imwrite("deg.png",img_lq)
